...
class ApplicationForm(forms.ModelForm):
    ...
    type = forms.ChoiceField(label='Записвам се за', required=True, choices=ChildApplication.TYPE_CHOICES,
    ...
    email = forms.EmailField(label='Поща', required=True, validators=[EmailValidator],
